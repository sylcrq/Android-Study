...
public class FoodFragment extends Fragment implements AdapterView.OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mFoodAdapter = new FoodAdapter(inflater);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        gridView.setAdapter(mFoodAdapter);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        int picID = Food.FOODS[position].getImageID();
        String name = Food.FOODS[position].getTitle();

        fragmentTransaction.replace(R.id.container, FoodDetailFragment.newInstance(picID, name));
